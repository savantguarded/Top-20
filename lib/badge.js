...
/**
 * Returns a JPEG. `rank`, `statusLabel`, `logo` (image buffer) are each optional;
 * `vignette` adds the corner falloff under the badge.
 */
async function applyOverlays(imageBuffer, { rank, statusLabel, corner = 'tl', shape = 'portrait', logo = null, vignette = false } = {}) {
