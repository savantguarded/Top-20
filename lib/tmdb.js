 ...
 * digital), Just Added, Now Streaming, Coming Soon (only with no digital release yet: a later
 * second digital date, e.g. a streaming debut after PVOD, must not re-trigger it), else none.
 */
 ...
 *  - Coming Soon: first episode not aired yet, premiere within the window.
 ...
 *  - Series Finale / Season Finale / New Episode: last aired episode within the window.
 */
