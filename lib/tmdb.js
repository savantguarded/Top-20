...
/**
 * Landscape art for one title. Always 'alternate' (the old 'main' option was removed from
 * /backstage):
 ...
 */
function landscapeArt(images, mainPath) {
  const textless = textlessBackdrops(images);
...
async function resolveMovie(m, cfg) {
  ...
  try {
    ...
    return {
      ...
      ...landscapeArt(details.images, details.backdrop_path),
