...
// A show that hasn't aired its first episode yet only gets "Coming Soon" once that premiere
// is within this many days -- a season announced months out doesn't need a pill yet. Same
// value as SHOW_RECENCY_WINDOW_DAYS by design (both mean "within a week"), kept as its own
// constant so the two can be tuned independently later without a naming clash.
