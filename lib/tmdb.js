 ...
 * Coming Soon, Premiere, New Episode, New Season [date], Season Finale [date], Series Finale.
...
function computeShowContext(details, showCfg) {
  ...
  if (recentSeason) {
    return recentSeason.season_number === 1
      ? 'Premiere'
      : `New Season ${formatShortDate(recentSeason.air_date)}`;
  }
