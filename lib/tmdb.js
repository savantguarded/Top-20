 ...
 *  - Premiere / Season Premiere: on the premiere day itself only.
...
function computeShowContext(details, showCfg) {
  ...
  if (recentPremiere && daysSince(premiereDate(recentPremiere)) === 0) return isSeries ? 'Premiere' : 'Season Premiere';
