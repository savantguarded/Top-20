...
const DEFAULTS = {
  ...
  // Base poster image source, as a URL template. `{imdbId}` is replaced with the
  // title's IMDb id (e.g. "tt1234567"). Swap providers by changing just this
  // string -- no code change. TMDB's own poster is always the automatic fallback
  // if this URL 404s or errors, regardless of what's set here.
  //
  // Examples:
...
module.exports = { getConfig, DEFAULTS, mergeDeep };
