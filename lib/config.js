...
const DEFAULTS = {
  ...
  // Which TMDB backdrop fills {backdrop_path} for the landscape card:
  //  - 'alternate' (default): a DIFFERENT image from the title's main backdrop, so the card
  //    doesn't repeat the big backdrop Nuvio shows behind the row. Chosen as whichever of the
  //    top-voted textless alternates looks least like the main one -- see lib/art.js.
  //  - 'main': the top-voted textless backdrop (usually the same image as the main one).
